...
export default function Product() {
  const [formData, setFormData] = useState({
    ...
    shoulderWidth: "",
    discountCode: "",
    productName: "Burgundy - White Embroidery", // This will be replaced by the script
  });
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          shoulderWidth: "",
          discountCode: "",
          productName: "Burgundy - White Embroidery",
        });
      } else {
    ...
    <div className="min-h-screen bg-cream">
      ...
      <div className="container mx-auto px-4 py-24">
        <div className="mb-4 text-sm">
          ...
          / <span className="text-secondary">Burgundy - White Embroidery</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-start space-y-2">
            <h1 className="text-2xl font-bold mb-4 text-black">Burgundy - White Embroidery</h1>
            <p className="text-base text-gray-700 mb-4">This Moroccan burgundy thobe features an intricate white embroidery design on the neckline, offering both traditional style and modern craftsmanship. The breathable fabric provides comfort in any setting.</p>
