...
export default function Product() {
  const [formData, setFormData] = useState({
    ...
    shoulderWidth: "",
    discountCode: "",
    productName: "Moroccan light blue Thobe", // This will be replaced by the script
  });
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          shoulderWidth: "",
          discountCode: "",
          productName: "Moroccan light blue Thobe",
        });
      } else {
    ...
    <div className="min-h-screen bg-cream">
      ...
      <div className="container mx-auto px-4 py-24">
        <div className="mb-4 text-sm">
          ...
          / <span className="text-secondary">Moroccan light blue Thobe</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-start space-y-2">
            <h1 className="text-2xl font-bold mb-4 text-black">Moroccan light blue Thobe</h1>
            <p className="text-base text-gray-700 mb-4">This sophisticated Moroccan grey thobe is designed with a blend of traditional embroidery and modern elegance. Made from high-quality, lightweight fabric, it offers comfort and durability for any occasion.</p>
