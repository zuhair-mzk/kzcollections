        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-gray-600 mt-4 text-center">
              This Emirati Kandora features a sleek, modern design in the white color. Crafted from high-quality, breathable fabric, it provides comfort and elegance for any occasion.
            </p>
          </div>
          <div className="flex flex-col justify-start space-y-2">
            <h1 className="text-2xl font-bold mb-4 text-black">Emirati white thobe</h1>
            <p className="text-base text-gray-700 mb-4">This Emirati Kandora features a sleek, modern design in the white color. Crafted from high-quality, breathable fabric, it provides comfort and elegance for any occasion.</p>
