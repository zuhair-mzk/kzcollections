...
export default function Product() {
  const [formData, setFormData] = useState({
    ...
    shoulderWidth: "",
    discountCode: "",
    productName: "Moroccan Brown - Geometric Embroidery", // This will be replaced by the script
  });
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          shoulderWidth: "",
          discountCode: "",
          productName: "Moroccan Brown - Geometric Embroidery",
        });
      } else {
    ...
    <div className="min-h-screen bg-cream">
      ...
      <div className="container mx-auto px-4 py-24">
        <div className="mb-4 text-sm">
          ...
          / <span className="text-secondary">Moroccan Brown - Geometric Embroidery</span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-start space-y-2">
            <h1 className="text-2xl font-bold mb-4 text-black">Moroccan Brown - Geometric Embroidery</h1>
            <p className="text-base text-gray-700 mb-4">This Moroccan brown thobe showcases a unique geometric embroidery pattern on the neckline and chest area. It is made from high-quality fabric that ensures comfort and style.</p>
