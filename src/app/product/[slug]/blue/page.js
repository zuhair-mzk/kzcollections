...
export default function Product() {
  const [formData, setFormData] = useState({
    ...
    shoulderWidth: "",
    discountCode: "",
    productName: "Blue", // This will be replaced by the script
  });
      ...
      <div className="container mx-auto px-4 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-start space-y-2">
            <h1 className="text-2xl font-bold mb-4 text-black">Blue</h1>
            <p className="text-base text-gray-700 mb-4">This stylish blue hooded thobe offers a relaxed and modern look, perfect for casual or formal wear.</p>
