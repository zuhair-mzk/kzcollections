...
export default function Product() {
  const [formData, setFormData] = useState({
    ...
    shoulderWidth: "",
    discountCode: "",
    productName: "Red", // This will be replaced by the script
  });
      ...
      <div className="container mx-auto px-4 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-start space-y-2">
            <h1 className="text-2xl font-bold mb-4 text-black">Red</h1>
            <p className="text-base text-gray-700 mb-4">A bold burgundy/red hooded thobe with golden embroidery, offering both elegance and casual comfort.</p>
